            ...
            <Row>
                ...
                <Col lg={3} className='show1'>
                        ...
                        <Row>
                        {
                            ...
                            <ul>
                                <li>Choose a draw to play in (all the draw are of the same format, just a different times)</li>
                                <li>If you play a game with type regular, you win some amount but if you play a game with type ordered; this means the result wold be same ewith your numbers i.e all numbers picked would be exactly the numbers drawn.</li>
                            </ul>
                                    </div> :
